...
const PortfolioDetails = (props) => {
  ...
  <section className="section" id="contact">
    ...
    <div>
      <h1 className='subtitle'> Nothing to see here! Please go to:</h1>
      <Link className='content' to='/add' className='content' style={{textDecoration: 'underline'}}>Add Resume</Link>
    </div>
  )
};
